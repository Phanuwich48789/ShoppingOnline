<div class="container-sm bg-glass mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-code"></i>&nbsp;จัดการโค้ด</h1>
    </center>
    <hr>
        ...
        <table id="table" class="table mt-2">
            <thead class="table-white bg-white ">
                <tr class="">
                    ...
                    <th scope="col" class="text-main">โค้ด</th>
                    <th scope="col" class="text-main">รางวัล (พ้อยท์)</th>
                    <th scope="col" class="text-main">จำนวนคนกรอกแล้ว</th>
                    <th scope="col" class="text-main">จำกัดจำนวน</th>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class="text-white" ><?php echo htmlspecialchars($row['code']);?></td>
                        <td class="text-white"><?php echo htmlspecialchars($row['prize']);?></td>
                        <td class="text-white"><?php echo number_format($row['count']);?></td>
                        <td class="text-white"><?php echo number_format($row['max_count']);?></td>
