<div class="container-sm bg-glass mt-5 border-2 shadow-sm p-4 mb-4 rounded" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-dice"></i>&nbsp;จัดการวงล้อ</h1>
    </center>
    <hr>
    ...
    <div class="table-responsive mt-3 ">
        <table id="table" class="table mt-2">
            <thead class="table-white bg-white ">
                <tr class="">
                    <th scope="col" class="text-main">ภาพวงล้อ</th>
                    <th scope="col" class="text-main">ชื่อวงล้อ</th>
                    <th scope="col" class="text-main">ราคา</th>
                    <th scope="col" class="text-main">รางวัล</th>
                    <th scope="col" class="text-main">แก้ไข</th>
                    <th scope="col" class="text-main">ลบ</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <td><a class="btn btn-warning text-dark w-100 col-4" style="width : 130px!important" href="?page=wheel&id=<?php echo $row["id"]; ?>"><i class="fa-solid fa-box"></i>&nbsp;จัดการ</a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;เพิ่มวงล้อ</h5>
            ...
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class="text-secondary mb-1">ชื่อวงล้อ <span class="text-danger">*</span></p>
                        ...
                        <div class="mb-2">
                            <p class="text-secondary mb-1">ราคาวงล้อ <span class="text-danger">*</span></p>
