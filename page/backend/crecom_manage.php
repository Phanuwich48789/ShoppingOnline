<div class="container-sm bg-glass mt-5 border-2 shadow-sm p-4 mb-4 rounded" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-fire"></i>&nbsp;ตั้งค่าหมวดหมู่แนะนำ</h1>
    </center>
    <hr>
    <div class="col-lg-6 m-auto">
        <div class="mb-2 mt-4">
            <p class="m-0 text-white">หมวดหมู่แนะนำ #1 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-white">หมวดหมู่แนะนำ #2 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-white">หมวดหมู่แนะนำ #3 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-white">หมวดหมู่แนะนำ #4 <span class="text-danger">*</span></p>
