<div class="container-sm bg-glass mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-shopping-basket"></i>&nbsp;จัดการหมวดหมู่</h1>
    </center>
    <hr>
        ...
        <table id="table" class="table mt-2">
            <thead class="table-white bg-white ">
                <tr class="">
                    ...
                    <th scope="col" class="text-main">ภาพหมวดหมู่</th>
                    <th scope="col" class="text-main">ชื่อหมวดหมู่</th>
                    <th scope="col" class="text-main">คำอธิบาย</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="text-white"><?php echo $row['c_id']; ?></td>
                        <td class="text-white"><img src="<?php echo htmlspecialchars($row['img']); ?>" width="100px" alt=""></td>
                        <td class="text-white"><?php echo htmlspecialchars($row['c_name']); ?></td>
                        <td class="text-white"><?php echo htmlspecialchars($row['des']); ?></td>
