<div class="container-sm bg-glass mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-shopping-basket"></i>&nbsp;จัดการสินค้า</h1>
    </center>
    <hr>
        ...
        <table id="table" class="table mt-2">
            <thead class="table-white bg-white ">
                <tr class="">
                    ...
                    <th scope="col" class="text-main">ภาพสินค้า</th>
                    <th scope="col" class="text-main">ชื่อสินค้า</th>
                    <th scope="col" class="text-main">ราคา</th>
                    <th scope="col" class="text-main">ชนิดการสุ่ม</th>
                    <th scope="col" class="text-main">หมวดหมู่</th>
                    <th scope="col" class="text-main">จัดการสต็อก</th>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-white"><?php
                                                ...
                                                ?></td>
                        <td class="text-white"><?php echo htmlspecialchars($row['c_type']); ?></td>
