<div class="container-sm bg-glass mt-5  shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-users"></i>&nbsp;จัดการผู้ใช้</h1>
    </center>
    <hr>
        ...
        <table id="table" class="text-center mt-4">
            <thead class="table-white bg-white">
                <tr class="text-center">
                    ...
                    <th scope="col" class="text-main">เงินคงเหลือ</th>
                    <th scope="col" class="text-main">ยอดการเติม</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-white"><?php echo number_format($row['point']); ?></td>
                        <td class="text-white"><?php echo htmlspecialchars($row['total']); ?></td>
