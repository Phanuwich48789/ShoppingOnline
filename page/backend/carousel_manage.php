<div class="container-sm bg-glass mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="text-white">&nbsp;<i class="fa-duotone fa-image"></i>&nbsp;จัดการภาพสไลด์</h1>
    </center>
    <hr>
        ...
        <table id="table" class="table mt-2">
            <thead class="table-white bg-white ">
                <tr class="">
                    ...
                    <th scope="col" class="text-main">ลิงค์รูปภาพ</th>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class="text-white" ><img src="<?php echo htmlspecialchars($row['link']);?>" width="100px" srcset=""></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;แก้ไขรูปภาพสไลด์</h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class="text-secondary mb-1">ลิ้งค์รูปภาพสไลด์<span class="text-danger">*</span></p>
